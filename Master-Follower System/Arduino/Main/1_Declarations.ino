...
// LINEAR TRANSLATION
  ...
  Encoder CATHETER_LINEAR_ENCODER(CATHETER_LINEAR_ENCODER_A_PIN, CATHETER_LINEAR_ENCODER_B_PIN);  // Encoder Variable
...
// ROTATION
  ...
  Encoder CATHETER_ROTATION_ENCODER(CATHETER_ROTATION_ENCODER_A_PIN, CATHETER_ROTATION_ENCODER_B_PIN);  // Encoder Variable
